...
// altrimenti come variante si può utilizzare anche lo switch valutando in base ai casi a disposizione
if (crewMass < 500) {
...
/* SOLUZIONE 10 */
dim_array = starWarsCharacters.length;
let random_element = Math.ceil(Math.random() * dim_array);

console.log(
  "Nome: " +
    starWarsCharacters[random_element].name +
    " Height: " +
    starWarsCharacters[random_element].height +
    " Mass: " +
    starWarsCharacters[random_element].mass +
    " Hair_color: " +
    starWarsCharacters[random_element].hair_color +
    " Skin_color: " +
    starWarsCharacters[random_element].skin_color +
    " Eye_color: " +
    starWarsCharacters[random_element].eye_color +
    " Birth_year: " +
    starWarsCharacters[random_element].birth_year +
    " Gender: " +
    starWarsCharacters[random_element].gender
);
